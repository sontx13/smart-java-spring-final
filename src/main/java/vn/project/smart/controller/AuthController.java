...
import vn.project.smart.domain.request.ReqLoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDto) {
        ...
        if (currentUserDB != null) {
            App app = currentUserDB.getApp();
            Company company = currentUserDB.getCompany();
    ...
    public ResponseEntity<ResLoginDTO.UserGetAccount> getAccount() {
        ...
        if (currentUserDB != null) {
            ...
            if (currentUserDB.getRole() != null) {
                ...
                userLogin.setApp(null); // hoặc tạo đối tượng App rỗng nếu cần
            }
            ...
            if (currentUserDB.getApp() != null) {
                userLogin.setApp(currentUserDB.getApp());
            } else {
                userLogin.setApp(null); // hoặc tạo đối tượng App rỗng nếu cần
            }
